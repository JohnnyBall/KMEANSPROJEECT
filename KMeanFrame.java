...
public class KMeanFrame extends JFrame implements ActionListener
{
    ...
    Vector<Vector<Point>> clusterVector;
    Vector<Point> meanVector;
...
//=================================================================================================================
  ...
  {
    Vector<Point> clusterValues = new Vector<Point>();
    Point  tmpPoint;
    ...
    while((clusterValues.size() < 20))
    {
        ...
        tmpPoint = new Point(rand.nextInt(20),rand.nextInt(20));
    ...
    clusterVector = new Vector<Vector<Point>>();
            ...
            for(int j = 0; j < clusterVector.get(i).size();j++)// iterates through the vector of vector points
            {
               ...
               for(int k = 0; k < meanVector.size();k++)
               {
                  ...
                  if(minValue > kmeansCalc)
                  {
                    ...
                    System.out.println("replacing minIndex:"+minIndex+ " with: "+k);
                    minIndex = k;
